        ...
        <div className="mx-w-4xl mx-auto">
            <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
                ...
                components={{
                    ...
                    tbody({children}){
                        return <tbody className="divide-y bg-gray-200">{children}</tbody>
                    },
                     tr({children}){
...
function CodeBlock({code,language}){
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200 ">
            ...
            <button onClick={copyCode} aria-label="Copy Code" className="text-gray-500 hover:text-gray-700 focus:outline-none relative group">
                {copied ? (
                ...
                {copied && (
                    <span className="absolute -top-8 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transition">
                        Copied!
                    </span>
                )}
            </button>
